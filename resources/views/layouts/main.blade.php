...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <title>{{ __('Reservas tours nacionales') }}</title>
    ...
    <!-- CSS Files -->
    <link href="{{ asset('/build/assets/material-dashboard.css? v=2.1.1') }}" rel="stylesheet" />
    ...
    <body class="{{ $class ?? '' }}">
        ...
        @endif
        <!--   Core JS Files   -->
        <script src="{{ asset('/build/assets/core/jquery.min.js') }}"></script>
        <script src="{{ asset('/build/assets/core/popper.min.js') }}"></script>
        <script src="{{ asset('/build/assets/core/bootstrap-material-design.min.js') }}"></script>
        <script src="{{ asset('/build/assets/plugins/perfect-scrollbar.jquery.min.js') }}"></script>
